app.controller('indexCtrl', function($scope, $routeParams, $location, $rootScope) {
	...
	$rootScope.changeDevice = function (val) {
		$rootScope.hasDevice = val;
	}
	...
	switch($rootScope.page.current) {
		...
		case 22:
			rezNum = 4;
			var exp5 = new Experiment({changeDistance: true, randomRange: true, size: true, callback: logData, noDevice: !$rootScope.hasDevice});
			break;
		default:
			$('.tooltip').hide()
			break;
